package com.luong.peepxuaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("peepxuaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("peepxuaa");
        ...
        config.getMapConfigs().put("com.luong.peepxuaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
