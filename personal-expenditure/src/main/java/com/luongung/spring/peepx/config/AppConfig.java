...
import com.luongung.spring.peepx.model.Authorities;
import com.luongung.spring.peepx.model.Budget;
...
@ComponentScan("com.luongung.spring.peepx")
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
	    ...
	    localSessionFactoryBean.setAnnotatedClasses(User.class, Authorities.class, 
	    		Budget.class, Category.class, Transaction.class);
